...
%changelog
* Fri Jun 14 2019 RDO <dev@lists.rdoproject.org> 6.2.2-1
- Update to 6.2.2

* Thu Apr 11 2019 RDO <dev@lists.rdoproject.org> 6.2.1-1
- Update to 6.2.1

* Wed Feb 20 2019 RDO <dev@lists.rdoproject.org> 6.2.0-1
- Update to 6.2.0
...
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/kolla/commit/?id=1e2ff199d4d639f45e7c476bb555d12316a6bfe3
