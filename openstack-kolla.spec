...
%changelog
* Wed Apr 19 2023 RDO <dev@lists.rdoproject.org> 13.10.0-1
- Update to 13.10.0

* Tue Feb 21 2023 RDO <dev@lists.rdoproject.org> 13.9.0-1
- Update to 13.9.0

* Fri Dec 09 2022 RDO <dev@lists.rdoproject.org> 13.8.0-1
- Update to 13.8.0

* Mon Nov 07 2022 RDO <dev@lists.rdoproject.org> 13.7.0-1
- Update to 13.7.0

* Thu Oct 06 2022 RDO <dev@lists.rdoproject.org> 13.6.0-1
- Update to 13.6.0

* Fri Sep 09 2022 RDO <dev@lists.rdoproject.org> 13.5.0-1
- Update to 13.5.0

* Thu Sep 01 2022 RDO <dev@lists.rdoproject.org> 13.4.0-1
- Update to 13.4.0

* Thu Aug 04 2022 RDO <dev@lists.rdoproject.org> 13.3.0-1
- Update to 13.3.0

* Thu Jul 07 2022 RDO <dev@lists.rdoproject.org> 13.2.0-1
- Update to 13.2.0

* Tue Jun 07 2022 RDO <dev@lists.rdoproject.org> 13.1.0-1
- Update to 13.1.0

* Mon Jan 03 2022 RDO <dev@lists.rdoproject.org> 13.0.1-1
- Update to 13.0.1

* Fri Nov 05 2021 RDO <dev@lists.rdoproject.org> 13.0.0-0.2.0rc1
- Update to 13.0.0.0rc2

* Mon Oct 18 2021 RDO <dev@lists.rdoproject.org> 13.0.0-0.1.0rc1
- Update to 13.0.0.0rc1

# REMOVEME: error caused by commit https://opendev.org/openstack/kolla/commit/8f076857fde79477432c1377559a452c265297ce
